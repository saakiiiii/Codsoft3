...
public class Main {
    ...
    public static void Ruppe_to_other(double amt) {
        ...
        System.out.println("1 Ruppe = " + 0.0096 + " Pound");
        System.out.println();
        System.out.println(amt+" Ruppe = " + (amt*0.0096) + " Pound");
    ...
    public static void Dollar_to_other(double amt) {
        ...
        System.out.println("1 Dollar= " + 0.7725+ " Pound");
        System.out.println();
        System.out.println(amt+" Dollar = " + (amt*0.7725) + " Pound");
    }
    ...
    public static void Euro_to_other(double amt){
        ...
        System.out.println("1 Euro = " + 0.85 + " Pound");
        System.out.println();
        System.out.println(amt+" Euro = " + (amt*0.85) + " Pound");
    }


    public static void Pound_to_other(double amt){
        System.out.println("1 Pound = " + 104 + " Ruppe");
        System.out.println();
        System.out.println(amt+" Pound = " + (amt*104) + " Ruppe");
        System.out.println();

        System.out.println("1 Pound = " + 1.27 + " Dollar");
        System.out.println();
        System.out.println(amt+" Pound = " + (amt*1.27) + " Dollar");
        System.out.println();
